    ...
    <div class="container-fluid vega-body" >
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <!--Card Default-->
                        <div class="card mdb-color lighten-2 text-center z-depth-2">
                            <div class="card-body">
                                <p class="white-text mb-0">This section Allow you to create and manage Students</p>
                ...
                <div class="col-md-3">
                    <button type="button" class="btn mdb-color" data-toggle="modal" data-target="#myModal">New Student</button>
                ...
                <tbody>
                   @foreach($students as $student)
                    <tr>
                        ...
                        <td></td>
                        <td><a href="{{url('progress')}}?id={{$student->id}} " class="btn btn-default btn-sm">view</a></td>
